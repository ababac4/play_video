...
/*-------------数据库信息-----------------*/
#define _DEF_DB_NAME    "video"
#define _DEF_DB_IP      "localhost"
#define _DEF_DB_USER    "root"
#define _DEF_DB_PWD     "ababac4"
/*--------------------------------------*/
...
public:
    STRU_FILEINFO():m_nFileID(0),m_VideoId(0),m_nPos(0),
        m_nFileSize(0),m_nUserId(0),pFile(0)
    {
