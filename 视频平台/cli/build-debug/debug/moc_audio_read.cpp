...
QT_MOC_LITERAL(1, 11, 22), // "SIG_sendAudioFrameData"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 8), // "uint8_t*"
QT_MOC_LITERAL(4, 44, 3), // "buf"
QT_MOC_LITERAL(5, 48, 11), // "buffer_size"
QT_MOC_LITERAL(6, 60, 13), // "slot_readMore"
QT_MOC_LITERAL(7, 74, 15), // "slot_closeAudio"
QT_MOC_LITERAL(8, 90, 14), // "slot_openAudio"
QT_MOC_LITERAL(9, 105, 6) // "UnInit"

    },
    "Audio_Read\0SIG_sendAudioFrameData\0\0"
    "uint8_t*\0buf\0buffer_size\0slot_readMore\0"
    "slot_closeAudio\0slot_openAudio\0UnInit"
};
...
void Audio_Read::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->slot_readMore(); break;
        case 2: _t->slot_closeAudio(); break;
        case 3: _t->slot_openAudio(); break;
        ...
        {
            using _t = void (Audio_Read::*)(uint8_t * , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Audio_Read::SIG_sendAudioFrameData)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Audio_Read::SIG_sendAudioFrameData(uint8_t * _t1, int _t2)
{
