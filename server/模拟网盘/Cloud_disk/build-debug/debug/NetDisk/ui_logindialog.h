...
public:
    ...
    void setupUi(QDialog *LoginDialog)
    {
        ...
        if (twg_myshare_file->columnCount() < 3)
            twg_myshare_file->setColumnCount(3);
        ...
        twg_myshare_file->horizontalHeader()->setDefaultSectionSize(200);
    ...
    void retranslateUi(QDialog *LoginDialog)
    {
        ...
        ___qtablewidgetitem17->setText(QApplication::translate("LoginDialog", "\346\226\260\345\273\272\345\210\227", nullptr));
